...
// Register routes
fastify.register(monitorRoutes, { monitorService, monitoringService });
fastify.register(monitoringRoutes, { monitoringService });
fastify.register(schedulerRoutes, { schedulerService });
