<template>
  <div
    class="bg-white dark:bg-slate-800 shadow-sm rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden"
  >
    <div v-if="monitors.length === 0" class="px-6 py-12 text-center">
      ...
      <p class="mt-2 text-sm text-gray-600 dark:text-slate-400">
        Add your first monitor to start monitoring your websites and services.
      </p>
    </div>
    ...
    <template v-else>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
          ...
          <tbody class="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
            ...
            >
              ...
              <td
                class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-slate-400 font-mono"
              >
                {{ monitor.url }}
              </td>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div class="flex items-center justify-end gap-2">
                  ...
                  >
                    <i
                      class="ti ti-refresh text-sm"
                      :class="{ 'animate-spin': checkingIds.has(monitor.id as number) }"
                    ></i>
                  </button>
                  <button
      ...
      <div
        v-if="totalPages > 1"
        class="px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-200 dark:border-slate-700"
      >
          ...
          <div class="flex items-center gap-1">
            <button
              ...
              :class="{
                ...
                'border-gray-300 dark:border-slate-600 text-gray-700 dark:text-slate-300 bg-white dark:bg-slate-700 hover:bg-gray-50 dark:hover:bg-slate-600':
                  page !== currentPage
              }"
            >
              {{ page }}
