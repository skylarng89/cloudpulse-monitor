<template>
  <div v-if="status" class="shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
    <div class="px-6 py-5">
      <div class="flex items-center justify-between">
        ...
        <span 
          ...
          :class="status.isRunning ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'"
        >
